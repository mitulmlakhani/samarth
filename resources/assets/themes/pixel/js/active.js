...
var text1 = $(".text1");
var textHeight = text1[0].scrollHeight;
var btn_read = $(".btn_read");
text1.css({"max-height": defaultHeight, "overflow": "hidden"});

btn_read.on("click", function(){
  var newHeight = 0;
  if ($(this).siblings('.text1').hasClass("active")) {
    newHeight = defaultHeight;
    $(this).siblings('.text1').removeClass("active");
  } else {
    newHeight = textHeight;
    $(this).siblings('.text1').addClass("active");
  }
  $(this).siblings('.text1').animate({
