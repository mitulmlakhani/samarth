...
class DistributorController extends Controller
{
    ...
    public function store(DistributorRequest $request) {
        ...
        return redirect()->route('admin.distributor')->with('success', 'New distributor created successfully.');
    }
    ...
    public function update(DistributorRequest $request, Distributor $distributor){
        ...
        return redirect()->route('admin.distributor')->with('success', 'Studio updated successfully.');
    }

    public function delete(Distributor $distributor) {
        $distributor->delete();

        return redirect()->route('admin.distributor')->with('success', 'Studio deleted successfully.');
    }
}
