        ...
        return datatables($query)
            ->addColumn('action', function($distributor) {
                return '<a class="btn btn-sm btn-primary" href="'. route('admin.distributor.edit', $distributor->id) .'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        <a class="btn btn-sm btn-danger" onclick="return confirm(\'Are you Sure ? Studio will be deleted !\')" href="'. route('admin.distributor.delete', $distributor->id) .'"><i class="fa fa-trash" aria-hidden="true"></i></a>';
            });
        }
